...
(function(document,window,navigator){
    ...
    function md5 (string, type) {
        ...
        if(type === 18){
            var bb = md5_WordToHex(b);
            var cc = md5_WordToHex(c)
            return (bb.charAt(0) + bb.charAt(1) + bb.charAt(2) + bb.charAt(3)  + bb.charAt(4) + bb.charAt(5) + bb.charAt(6) + bb.charAt(7) + "-" + cc.charAt(0) + cc.charAt(1) + cc.charAt(2) + cc.charAt(3) + "-" + cc.charAt(4) + cc.charAt(5) + cc.charAt(6) + cc.charAt(7) ).toLowerCase();
        }
    ...
    pub.calculateDeviceId = function () {
        ...
        try {
            ...
            device.attr = a + (t << 1) + (e << 2) + (n << 3) + (o << 4) + (m << 5) + (r << 6) + (i << 7) + (s << 8) + (l << 9) + (c << 10) + (b << 11) + (d << 12) + (k << 13)
        } catch (e) {
            device.attr = 0;
        }
        ...
        device.fp = "" + canvas("<@nv45. F1n63r,Pr1n71n6!") + "," + canvas("m,Ev!xV67BaU> eh2m<f3AG3@");
        device.ua = document.quickHash(navigator.userAgent)
